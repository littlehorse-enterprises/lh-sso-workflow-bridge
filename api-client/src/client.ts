...
export class LittleHorseUserTasksApiClient {
   ...
   * ```
   */
  async completeUserTask(userTask: UserTask, values: UserTaskResult): Promise<void> {
   ...
   * ```
   */
  async adminAssignUserTask(userTask: UserTask, assignTo: { userId?: string; userGroupId?: string}): Promise<void> {
